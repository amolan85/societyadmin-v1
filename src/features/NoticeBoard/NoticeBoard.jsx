...
const NoticeBoard = () => {
    ...
    return (
        ...
        //             </div>
        //             {posts.map((p, i, arr) => (
        //                 <div className='text-start' key={i} style={{ padding: "14px 0", borderBottom: i < arr.length - 1 ? "1px solid var(--border)" : "none" }}>
        ...
        //                     </div>
        //                     <p className="text-start" style={{ fontSize: 12, color: "#374141", marginBottom: 10 }}>"{m.text}"</p>
